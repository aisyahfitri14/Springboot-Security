...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2021 at 03:40 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_emp` ()  NO SQL
SELECT e.first_name, j.job_title, d.department_name
FROM employees e join jobs j ON j.job_id = e.job_id
join departments d on d.department_id = e.department_id$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `get_detail_city` ()  NO SQL
...
(100, 'Steven', 'King', 'kel1pastibisa@gmail.com', '515.123.4567', '1987-06-17', 'AD_PRES', '24000.00', NULL, NULL, 90),
(101, 'Neena', 'Kochhar', 'kel1pastibisa@gmail.com', '515.123.4568', '1989-09-21', 'AD_VP', '17000.00', NULL, 100, 90),
(102, 'Lex', 'De Haan', 'kel1pastibisa@gmail.com', '515.123.4569', '1993-01-13', 'AD_VP', '17000.00', NULL, 100, 90),
(103, 'Alexander', 'Hunold', 'kel1pastibisa@gmail.com', '590.423.4567', '1990-01-03', 'IT_PROG', '9000.00', NULL, 102, 60),
(104, 'Bruce', 'Ernst', 'kel1pastibisa@gmail.com', '590.423.4568', '1991-05-21', 'IT_PROG', '6000.00', NULL, 103, 60),
...
(313, 'TEST00000', 'TES', 'qws', '243', '2020-12-02', 'PU_MAN', '1200.00', '0.00', 117, 160);
...
INSERT INTO `users` (`id`, `username`, `password`, `verification_code`, `status`, `is_user_verified`) VALUES
(100, 'TESTING', '12345', NULL, 0, 1),
(101, 'testEncrip', 'Ü›¯Iä”•i:âþÝ˜™šØÆ·ñ¿=ß·j$4Ì=', NULL, 0, 1),
(102, 'testt', '1234', NULL, 0, 1),
(103, 'Aisyah', '12345', NULL, 0, 1);
...
ALTER TABLE `countries`
  ...
  ADD CONSTRAINT `countries_ibfk_2` FOREIGN KEY (`region_id`) REFERENCES `regions` (`region_id`);
...
ALTER TABLE `departments`
  ...
  ADD CONSTRAINT `departments_ibfk_3` FOREIGN KEY (`manager_id`) REFERENCES `employees` (`employee_id`);
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_4` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
  ADD CONSTRAINT `employees_ibfk_5` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
  ADD CONSTRAINT `employees_ibfk_6` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
  ADD CONSTRAINT `employees_ibfk_7` FOREIGN KEY (`manager_id`) REFERENCES `employees` (`employee_id`);
...
ALTER TABLE `locations`
  ...
  ADD CONSTRAINT `locations_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`);

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `userEmpFK` FOREIGN KEY (`id`) REFERENCES `employees` (`employee_id`),
  ADD CONSTRAINT `userStatusFK` FOREIGN KEY (`status`) REFERENCES `status` (`id`);
